...
class Products extends StatefulWidget {
  ...
  final Function showUpdateProductModal;
  const Products({Key? key, required this.addToList, required this.showUpdateProductModal}) : super(key: key);
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  IconButton(
                                      onPressed: () {
                                        widget.showUpdateProductModal(products[i]['id']);
                                      },
                                      padding: EdgeInsets.zero,
                                      constraints: const BoxConstraints(),
                                      icon: Icon(
